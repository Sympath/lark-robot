...
function generateHomePage(larkService) {
    return `
    <!DOCTYPE html>
    <html lang="zh-CN">
    <head>
        ...
        <div class="container">
            ...
            <div class="grid">
                <div class="card">
                    ...
                    <p>端口: ${config_1.default.port}</p>
                    <p>环境: ${config_1.default.environment}</p>
                </div>
                
                <div class="card">
                    <h2>⚙️ 配置信息</h2>
                    <p><strong>App ID:</strong> <code>${config_1.default.appId}</code></p>
                    <p><strong>验证令牌:</strong> <code>${config_1.default.verificationToken}</code></p>
                </div>
            </div>
            ...
            <div class="card">
                <h2>📖 使用说明</h2>
                <p>1. 在飞书开发者后台配置 Webhook URL: <code>http://${config_1.default.host}:${config_1.default.port}/api/callback</code></p>
                <p>2. 设置验证令牌: <code>${config_1.default.verificationToken}</code></p>
